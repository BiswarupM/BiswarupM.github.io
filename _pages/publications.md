...
<div class="page__title-bar">Publications</div>
<!--
...
/* Year heading, such as 2023 */
#bibbase_body .bibbase_group {
...
/* Remove BibBase's indentation */
#bibbase_body .bibbase_group_body {
  padding: 0 !important;
  margin: 0 !important;
}
...
/* Author names */
#bibbase_body .bibbase_paper_author {
  font-size: 1em !important;
  font-weight: 400;
}

/* DOI, link, BibTeX and abstract controls */
#bibbase_body span.bibbase_paper_content {
  display: block;
  font-size: 0.9em;
  margin-top: 0.4rem;
}

/* Expanded abstract and BibTeX panels */
#bibbase_body .bibbase_paper .well {
...
/* Card hover effect */
#bibbase_body .bibbase_paper:hover {
...
Selected publications in power systems modeling, simulation, and applied optimization are listed below. My updated publication record and citation profile are available on <a href="https://scholar.google.com/citations?hl=en&user=6mAbTlUAAAAJ">Google Scholar</a>, while open-access versions can be accessed through <a href="https://cv.archives-ouvertes.fr/biswarup-mukherjee">HAL</a>.
  </p>
